...
class Save_fct():
    ...
    def __init__(self,RowSeparator,ColumnSeparator,FileName,Dated):
        ...
        if(Dated):
            self.name = "/home/pi/Desktop/01_12_2020_V2/log/"+FileName+'_'+'Date_'+str(x)[0:10]+'_'+str(x)[11:13]+'-'+str(x)[14:16]+".csv"
        else:
            self.name = "/home/pi/Desktop/01_12_2020_V2/log/"+FileName+".csv"
